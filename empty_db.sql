...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2024 at 09:11 AM
...
`id` int(11) NOT NULL,
  ...
  `browser_info` text CHARACTER SET utf8
...
`id` int(11) NOT NULL,
  ...
  `paid_last_update` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `doctor` text,
  `code` text,
  `warehouse_synced` tinyint(1) NOT NULL DEFAULT '0',
...
`id` int(11) NOT NULL,
  ...
  `never_end` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `reflected_to_profit` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `gaz_station`
--

CREATE TABLE IF NOT EXISTS `gaz_station` (
`id` int(11) NOT NULL,
  `name` varchar(500) DEFAULT NULL,
  `item_id` int(11) NOT NULL DEFAULT '0',
  `starting_counter` decimal(25,5) NOT NULL DEFAULT '0.00000',
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `creation_date` datetime DEFAULT NULL,
  `created_by` int(11) NOT NULL DEFAULT '0',
  `max_stock` decimal(20,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `gaz_station_counter`
--

CREATE TABLE IF NOT EXISTS `gaz_station_counter` (
`id` int(11) NOT NULL,
  `gaz_station_id` int(11) NOT NULL DEFAULT '0',
  `old_counter` decimal(25,5) NOT NULL DEFAULT '0.00000',
  `new_counter` decimal(25,5) NOT NULL DEFAULT '0.00000',
  `creation_date` datetime DEFAULT NULL,
  `created_by` int(11) NOT NULL DEFAULT '0',
  `invoice_id` int(11) NOT NULL DEFAULT '0',
  `debt` decimal(20,5) NOT NULL DEFAULT '0.00000',
  `cash` decimal(20,5) NOT NULL DEFAULT '0.00000',
  `available_stock` decimal(25,5) NOT NULL DEFAULT '0.00000',
  `deleted` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `related_to_client_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `average_cost` decimal(20,5) NOT NULL DEFAULT '0.00000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `cashbox_info` text,
  `log_note` text,
  `vendor_commission_percentage` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `due_date_dismiss` tinyint(1) NOT NULL DEFAULT '0',
  `station_generated` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `selling_price` decimal(30,5) DEFAULT NULL,
  `discount` decimal(30,5) DEFAULT NULL,
  `final_cost_vat_qty` decimal(20,5) DEFAULT NULL,
  `final_price_disc_qty` decimal(20,5) DEFAULT NULL,
  `profit` decimal(30,5) DEFAULT NULL,
...
`id` int(11) NOT NULL,
  ...
  `fixed_rate` tinyint(1) NOT NULL DEFAULT '0',
  `fixed_rate_value` decimal(20,5) NOT NULL DEFAULT '0.00000',
...
--
-- Table structure for table `items_categories_mov_logs`
--
...
`id` int(11) NOT NULL,
  `creation_date` datetime DEFAULT NULL,
  `logs` longtext,
  `from_subcategory_id` int(11) NOT NULL DEFAULT '0',
  `to_subcategory_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `hide_after` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `optic_details`
--
...
--
-- Table structure for table `optic_logs`
--

CREATE TABLE IF NOT EXISTS `optic_logs` (
`id` int(11) NOT NULL,
  `created_by` int(11) DEFAULT NULL,
  `related_to_optic_id` int(11) DEFAULT NULL,
  `description` text,
  `other_info` text,
  `creation_date` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `note` text,
  `location` text,
  `is_current_temp` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `prepare_invoices_details`
--

CREATE TABLE IF NOT EXISTS `prepare_invoices_details` (
`id` int(11) NOT NULL,
  `prepare_invoice_id` int(11) NOT NULL DEFAULT '0',
  `item_id` int(11) NOT NULL DEFAULT '0',
  `qty` decimal(20,5) NOT NULL DEFAULT '0.00000',
  `price` decimal(20,5) NOT NULL DEFAULT '0.00000',
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `composite_qty` decimal(20,5) NOT NULL DEFAULT '0.00000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `quotation_type` int(11) NOT NULL DEFAULT '0',
  `foreign_invoice_id` int(11) NOT NULL DEFAULT '0',
  `vendor_commission_percentage` decimal(10,4) NOT NULL DEFAULT '0.0000'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `vat_value` decimal(20,5) DEFAULT '0.00000',
  `final_price` decimal(20,5) NOT NULL DEFAULT '0.00000',
  `final_cost` decimal(20,5) NOT NULL DEFAULT '0.00000',
  `profit` decimal(20,5) NOT NULL DEFAULT '0.00000',
  `deleted` tinyint(1) DEFAULT '0',
  `foreign_item_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `created_by` int(11) NOT NULL DEFAULT '0',
  `charge_type` int(11) NOT NULL DEFAULT '1',
  `total_qty` decimal(20,5) NOT NULL DEFAULT '0.00000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `receive_stock_logs`
--

CREATE TABLE IF NOT EXISTS `receive_stock_logs` (
`id` int(11) NOT NULL,
  `creation_date` datetime DEFAULT NULL,
  `created_by` int(11) NOT NULL DEFAULT '0',
  `pi_id` int(11) NOT NULL DEFAULT '0',
  `description` text,
  `related_to_item_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=1 ;
...
(183, 'last_backup', '2024-05-25 19:47:27'),
...
(366, 'pos_payment_default_zero_values', '0'),
...
(384, 'enable_add_item_from_pos', '0'),
(385, 'max_users', '5'),
(386, 'enable_invoice_tax', '0'),
(387, 'enable_invoice_freight', '0'),
(388, 'force_round_lbp_on_pos', '0'),
(390, 'enable_optic', '0'),
(392, 'enable_working_hours', '0'),
(393, 'force_round_up_lbp_on_pos', '0'),
(394, 'quick_financial_report', '0'),
(395, 'show_barcode_in_invoice', '0'),
(399, 'pos_disable_edit_payment', '0'),
(403, 'do_not_sell_boxes', '0'),
(404, 'quotation_show_clients_only_by_users_created', '0'),
(405, 'arabic_stmt_and_invoice', '0'),
(406, 'default_due_date_invoice', '15'),
(408, 'shareholders_report', '0'),
(409, 'default_charge_type', '1'),
(410, 'max_upload_images_size_gb', '5'),
(411, 'invoice_note', '0'),
(412, 'clients_show_only_by_users_created', '0'),
(413, 'notification_for_password_security_check', '1'),
(414, 'starting_barcode', '9'),
(415, 'archive', 'https://archivedata.upsilon.systems/archive.php'),
(416, 'apply_vat_on_sales_invoice', '0'),
(418, 'gallery_default_price', '1'),
(420, 'disable_delete_payment_on_pos', '0'),
(421, 'invoice_taxable_enabled', '0'),
(423, 'composite_auto_set_cost_and_price', '0'),
(424, 'main_pictures_path', NULL),
(425, 'enable_pda', '0'),
(426, 'show_cost_in_gallery', '0'),
(427, 'gallery_show_by_boxes', '0'),
(429, 'gaz_station', '0'),
(431, 'cloudflare_enable_turnstile', '0'),
(437, 'pi_unique_barcode', '1');
...
`id` int(11) NOT NULL,
  ...
  `removed_from_system` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `shareholders_details`
--
...
--
-- Table structure for table `shareholders_logs`
--
...
`id` int(11) NOT NULL,
  ...
  `deleted` tinyint(1) DEFAULT '0',
  `store_id` int(11) DEFAULT NULL,
  `excel_total_rows_nb` int(11) NOT NULL DEFAULT '0',
  `excel_name` text,
  `scanner_qty_success` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `packs_nb` decimal(20,5) NOT NULL DEFAULT '0.00000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`id` int(11) NOT NULL,
  ...
  `note` text,
  `invoice_id` int(11) NOT NULL DEFAULT '0',
  `registered_in_store_id` int(11) NOT NULL DEFAULT '0',
  `warehouse_synced` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
INSERT INTO `users` (`id`, `username`, `password`, `role_id`, `store_id`, `deleted`, `name`, `creation_date`, `check_key`, `demo`, `hide_critical_data`, `is_safe`, `operator_is_admin`, `authorization_required`, `commission`) VALUES
(1, 'admin', '123456', 1, 1, 0, NULL, NULL, 'X3RL1PlgQef25aVeclSN', 0, 0, 0, 0, 0, '0.0000'),
(2, 'pos', '123456', 2, 1, 0, NULL, NULL, 'f95ZK5Z4hOU2a485iRgM', 0, 0, 0, 0, 1, '0.0000');
...
--
-- Table structure for table `woocommerce_items`
--

CREATE TABLE IF NOT EXISTS `woocommerce_items` (
`id` int(11) NOT NULL,
...
--
-- Table structure for table `woocommerce_items_logs`
--

CREATE TABLE IF NOT EXISTS `woocommerce_items_logs` (
`id` int(11) NOT NULL,
  `created_by` int(11) DEFAULT NULL,
  `related_to_pos_item_id` int(11) DEFAULT NULL,
  `woocommerce_item_id` int(11) DEFAULT NULL,
  `description` text,
...
--
-- Table structure for table `woocommerce_parent_categories`
--

CREATE TABLE IF NOT EXISTS `woocommerce_parent_categories` (
`id` int(11) NOT NULL,
  `pos_parent_category_id` int(11) DEFAULT NULL,
...
--
-- Indexes for table `gaz_station`
--
ALTER TABLE `gaz_station`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `gaz_station_counter`
--
ALTER TABLE `gaz_station_counter`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `global_clients`
--
...
--
-- Indexes for table `items_categories_mov_logs`
--
...
--
-- Indexes for table `optic_details`
--
ALTER TABLE `optic_details`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `optic_logs`
--
ALTER TABLE `optic_logs`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `prepare_invoices`
--
ALTER TABLE `prepare_invoices`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `prepare_invoices_details`
--
ALTER TABLE `prepare_invoices_details`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `receive_stock_logs`
--
ALTER TABLE `receive_stock_logs`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `shareholders_details`
--
ALTER TABLE `shareholders_details`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shareholders_logs`
--
...
--
-- Indexes for table `woocommerce_items`
--
ALTER TABLE `woocommerce_items`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `woocommerce_items_logs`
--
ALTER TABLE `woocommerce_items_logs`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `woocommerce_parent_categories`
--
ALTER TABLE `woocommerce_parent_categories`
 ADD PRIMARY KEY (`id`);
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `gaz_station`
--
ALTER TABLE `gaz_station`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `gaz_station_counter`
--
ALTER TABLE `gaz_station_counter`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `global_clients`
--
ALTER TABLE `global_clients`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `items_categories_mov_logs`
--
ALTER TABLE `items_categories_mov_logs`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `optic_details`
--
ALTER TABLE `optic_details`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `optic_logs`
--
ALTER TABLE `optic_logs`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `prepare_invoices`
--
ALTER TABLE `prepare_invoices`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `prepare_invoices_details`
--
ALTER TABLE `prepare_invoices_details`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `receive_stock_logs`
--
ALTER TABLE `receive_stock_logs`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `shareholders_details`
--
ALTER TABLE `shareholders_details`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `shareholders_logs`
--
ALTER TABLE `shareholders_logs`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `woocommerce_items`
--
ALTER TABLE `woocommerce_items`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `woocommerce_items_logs`
--
ALTER TABLE `woocommerce_items_logs`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `woocommerce_parent_categories`
--
ALTER TABLE `woocommerce_parent_categories`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
