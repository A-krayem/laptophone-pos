    ...
    <body class="A4">
        ...
        <table class="inv_table" style="margin-top: 5px;">
            <tr>
                ...
                <td style="width: 100px;font-size: 15px;"><b>Type</b></td>
                  ...
                  <td style="font-size: 14px;">
                      <?php 
                        if($item_info[0]["is_composite"]==0){
                            ...
                            $item_info = $data["items_instance"]->get_composite_item_id($data["invoice_items"][$i]["item_id"]);
                           echo "Box/". floatval($item_info[0]["qty"]); 
                        }
              ...
              <?php if($data["currency_system_default"]==1){ ?>
                ...
                <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                    ...
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><b> <?php echo number_format($data["previews_balance"],2); ?> <?php echo $currency_symbole; ?></b></td> 
                </tr>
                <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                    ...
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><b><?php echo self::value_format_custom($data["previews_balance"]+$total_before_vat+$total_invoice_vat+$data["invoice"][0]["invoice_discount"],$this->settings_info); ?></b></td> 
                </tr>
                <?php } ?>
