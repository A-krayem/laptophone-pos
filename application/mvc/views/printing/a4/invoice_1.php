    ...
    <body>
        ...
        <table class="inv_table" style="margin-top: 5px;">
            <tr>
                ...
                <td style="width: 63px; font-size: 13px;"><b>Barcode</b></td>
                ...
                <td style="width: 20px;font-size: 13px;"><b>Disc.</b></td>
                ...
                for($i=0;$i<count($data["invoice_items"]);$i++){ 
                    ...
                    if($data["currency_request_id"]!=$data["currency_system_default"] && $data["currency_request_id"]!=0){
                        $total_before_vat+= ($data["invoice_items"][$i]["selling_price"]*(1-$data["invoice_items"][$i]["discount"]/100))*floor($data["invoice_items"][$i]["qty"])/$data["currencies"][$data["currency_request_id"]]["rate_to_system_default"];
                    }else{
              ...
              <tr>
                  ...
                  <td><?php echo $item_info[0]["barcode"]; ?></td>
                  <td>
                      <?php 
                  ...
                  <td>
                      ...
                      if($data["invoice_items"][$i]["discount"]<0){
                        echo self::value_format_custom($data["invoice_items"][$i]["selling_price"]*(1-$data["invoice_items"][$i]["discount"]/100),$this->settings_info); 
                      }else{
                        echo self::value_format_custom($data["invoice_items"][$i]["selling_price"],$this->settings_info); 
                      }
                      ?>
                  </td>
                  ...
                  <td style="text-align: center">
                      ...
                      if($data["invoice_items"][$i]["discount"]<0){
                          ...
                          echo $data["invoice_items"][$i]["discount"]."%";
                      }
                      
                      ?>
                  </td>
                  <td><?php echo self::value_format_custom(($data["invoice_items"][$i]["selling_price"]*(1-$data["invoice_items"][$i]["discount"]/100))*floor($data["invoice_items"][$i]["qty"]),$this->settings_info); ?></td>
                  ...
                  <?php 
                      ...
                      if($data["currency_request_id"]!=$data["currency_system_default"] && $data["currency_request_id"]!=0){
                          $fn = round($data["invoice_items"][$i]["final_price_disc_qty"]/$data["currencies"][$data["currency_request_id"]]["rate_to_system_default"],$this->settings_info["round_val"]);
                      }
              ...
              <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                  <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important;" colspan="6" ><b>Invoice Discount: </b></td>
              ...
              <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                  <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important;font-size: 14px" colspan="6" >Sub Total:</td>
                  <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><?php echo self::value_format_custom($total_before_vat,$this->settings_info); ?></td>
              </tr>
              ...
              <?php 
                if($data["currency_request_id"]!=$data["currency_system_default"] && $data["currency_request_id"]!=0){
                    ?>
                        <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                            <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important; font-size: 14px" colspan="6" ><b>Total <?php echo $data["currencies"][$data["currency_request_id"]]["symbole"]; ?> @ VAT <?php echo (($this->settings_info["vat"]-1)*100) ?> %: </b></td>
                            <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" >
                                <b>
                                <?php 
                                $setting_inf = $this->settings_info;
                                $setting_inf["default_currency_symbol"] = $data["currencies"][$data["currency_request_id"]]["symbole"];
                                if($data["invoice"][0]["total_vat_value"]>0){
                                    echo self::value_format_custom(($total_before_vat*$this->settings_info["vat"]-$total_before_vat),$this->settings_info);
                                }else{
                                    echo self::value_format_custom(0,$this->settings_info); 
                                }
                                ?>
                                </b>
                            </td>
                        ...
                        <?php if($data["currencies"][$data["currency_request_id"]]["default_vat"]==0){ 
                            ?>
                        <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                            <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important; font-size: 14px" colspan="6" ><b>Total LBP<?php echo $data["default_vat_symbole"]; ?> @ VAT <?php echo (($this->settings_info["vat"]-1)*100) ?> %: </b></td>
                            <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" >
                                <b>
                                <?php 
                                $setting_inf = $this->settings_info;
                                $setting_inf["default_currency_symbol"] = $data["default_vat_symbole"];
                                if($data["invoice"][0]["total_vat_value"]>0){
                                    echo self::value_format_custom(($total_before_vat*$this->settings_info["vat"]-$total_before_vat)*$data["currencies"][$data["currency_request_id"]]["rate_to_system_default"],$setting_inf); //*$data["currencies"][$data["currency_request_id"]]["rate_to_system_default"]
                                }else{
                                    echo self::value_format_custom(0,$setting_inf); //*$data["currencies"][$data["currency_request_id"]]["rate_to_system_default"]
                    ...
                    <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                        <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important; font-size: 14px" colspan="6" ><b>Total LBP @ VAT <?php echo (($this->settings_info["vat"]-1)*100) ?> %: </b></td>
                        <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" >
                            <b>
                            <?php 
                            if($data["invoice"][0]["total_vat_value"]>0){
                                echo self::value_format_custom(($total_before_vat*$this->settings_info["vat"]-$total_before_vat)/$data["currencies"][2]["rate_to_system_default"],$this->settings_info); 
                            }else{
                                echo self::value_format_custom(0,$this->settings_info); 
                            }
                            ?>
              ...
              <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important;font-size: 14px" colspan="6" ><b>Net Amount: </b></td>
                 
                    <?php if($data["invoice"][0]["total_vat_value"]>0){ ?>
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><b><?php echo self::value_format_custom($total_before_vat*$this->settings_info["vat"],$this->settings_info); ?></b></td>
                    <?php }else{ ?>
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><b><?php echo self::value_format_custom($total_before_vat,$this->settings_info); ?></b></td>
                    <?php } ?>     
