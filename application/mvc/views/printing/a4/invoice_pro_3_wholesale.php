...
<html>
    ...
    <body class="A4">
        ...
        if($data["arabic_stmt_and_invoice"]==1){
            ...
            $lang_price_u="السعر<br/>الافرادي";
            $lang_discount_u="حسم";
            
            $lang_total="السعر<br/>الإجمالي";
            
            $lang_total_items="الكمية الاجمالي";
            
            $lang_qty="عدد الصناديق";
            $lang_quantities="التعبئة<br/>داخل الصندوق";
            
            $lang_description="اسم الصنف";
            ...
            $lang_barcode="باركود";
            $lang_code="رقم الصندوق";
            $lang_nb="رقم<br/>التسلسلي";
        } 
        ...
        <table class="inv_table" style="margin-top: 5px;" dir="<?php echo $dir; ?>">
            <thead>
            <tr>
                <td class="headt" style="text-align: center;width: 55px;"><b><?php echo $lang_nb; ?></b></td>
                <td class="headt" style=" text-align: center;width: 80px;"><b><?php echo $lang_barcode; ?></b></td>
                <td class="headt" style=" text-align: center;width: 80px;"><b><?php echo $lang_code; ?></b></td>
                <td class="headt" style="text-align: center;"><b><?php echo $lang_description; ?></b></td>
                <td class="headt" style="text-align: center;width: 55px !important; display: none"><b><?php echo $lang_unit; ?></b></td>
                
                <td class="headt" style="text-align: center;width: 45px;"><b><?php echo $lang_qty; ?></b></td>
                <td class="headt" style="text-align: center;width: 75px;"><b><?php echo $lang_quantities; ?></b></td>
                <td class="headt" style="text-align: center;width: 55px;"><b><?php echo $lang_total_items; ?></b></td>
                
                <td class="headt" style=" text-align: center;width: 60px;"><b><?php echo $lang_price_u; ?></b></td>
                <td class="headt" style=" text-align: center;width: 60px; display: none"><b><?php echo $lang_discount_u; ?></b></td>
                 ...
                 if($item_info[0]["is_composite"]==0){
                  ...
                  <td style="text-align: center;font-size: 12px;text-align: center">
                      ...
                      if($item_info[0]["is_composite"]==0){
                          ...
                          echo floatval($item_info_b[0]["qty"]);
                      }
                  ...
                  <td style="font-size: 12px; width: 70px;text-align: center">
                      ...
                      if($item_info[0]["is_composite"]==0){
                         ...
                         echo self::value_format_custom_no_currency(($data["invoice_items"][$i]["selling_price"]*(1-$data["invoice_items"][$i]["discount"]/100))/$item_info_b[0]["qty"],$this->settings_info); 
                      }
                  ...
                  <td style="font-size: 12px;text-align: center; display: none">
                      <?php 
           ...
           <tbody>
               ...
               <tr>
                   <td style="text-align: right;"> 
                    ...
                    <?php
                    if(abs($data["invoice"][0]["invoice_discount"])>0){
                   ...
                   <td>&nbsp;</td>
                   <td style="text-align: left;"><?php echo $lang_total_items;?>:&nbsp;<b><?php echo $total_bixes_items_qty; ?></b></td>
               </tr>
               <tr>
