        ...
        <table class="inv_table" style="margin-top: 5px;">
            <tr>
              ...
              <tr>
                  ...
                  <td style="font-size: 14px;"><?php echo self::value_format_custom_no_currency(($data["invoice_items"][$i]["selling_price"]*(1-$data["invoice_items"][$i]["discount"]/100))*floor($data["invoice_items"][$i]["qty"]),$this->settings_info).$currency_symbole; ?></td>
              ...
              <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                    ...
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><b><?php echo self::value_format_custom_no_currency(($total_before_vat+$data["invoice"][0]["invoice_discount"])*$this->settings_info["vat"],$this->settings_info).$currency_symbole; ?></b></td>
                    <?php }else{ ?>
              ...
              <?php if($data["currency_system_default"]==1){ ?>
                <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                    ...
                    <?php if($data["invoice"][0]["total_vat_value"]>0){ ?>
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><b><?php echo self::value_format_custom_no_currency(($total_before_vat+$data["invoice"][0]["invoice_discount"])*$this->settings_info["vat"]*$data["invoice"][0]["rate"],$this->settings_info)." LBP"; ?></b></td>
                    <?php }else{ ?>
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><b><?php echo self::value_format_custom_no_currency(($total_before_vat+$data["invoice"][0]["invoice_discount"])*$data["invoice"][0]["rate"],$this->settings_info)." LBP"; ?></b></td>
                    <?php } ?>     
                ...
                <?php if($data["currency_system_default"]==1 && $data["invoice"][0]["total_vat_value"]>0){ ?>
                <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important; font-size: 14px" colspan="5" ><b>Total LBP @ VAT <?php echo (($this->settings_info["vat"]-1)*100) ?> %: </b></td>
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" >
                        ...
                        if($data["invoice"][0]["total_vat_value"]>0){
                            echo self::value_format_custom(($total_before_vat*$this->settings_info["vat"]-$total_before_vat)*$data["currencies"][1]["rate_to_system_default"],$this->settings_info); 
                        }
                        ?>
                        </b>
                    </td>
                ...
                <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important;font-size: 14px" colspan="5" ><b>Previous Balance: </b></td>
                ...
                <tr style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important; border-top: 0px !important;">
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;text-align:right;border-top: 0px !important;font-size: 14px" colspan="5" ><b>Total Balance till <?php echo $data["invoice"][0]["creation_date"]; ?>: </b></td>
                    <td style="border-left: 0px !important; border-right: 0px !important; border-bottom:0px !important;width: 150px;;border-top: 0px !important;font-size: 14px" ><b><?php echo self::value_format_custom(round($data["previews_balance"],2)+$total_before_vat+$data["invoice"][0]["invoice_discount"],$this->settings_info); ?></b></td> 
                </tr>
