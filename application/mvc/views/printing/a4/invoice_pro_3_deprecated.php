...
<html>
    ...
    <body class="A4">
        ...
        if($data["arabic_stmt_and_invoice"]==1){
            ...
            $lang_price_u="السعر للوحدة";
            $lang_discount_u="حسم";
            
            $lang_total="المجموع";
            
            $lang_qty="عدد الوحدات";
            $lang_quantities="مجموع القطع";
        ...
        <table class="inv_table" style="margin-top: 5px;" dir="<?php echo $dir; ?>">
            <tr>
                ...
                <td class="headt" style="text-align: center;width: 70px;"><b><?php echo $lang_quantities; ?></b></td>
       ...
       <div class="row" style="margin-top: 10px;" dir="<?php echo $dir; ?>">
            <div class="col-lg-3" style="text-align: left;"><?php echo $lang_total_boxes;?>:&nbsp;<b><?php echo $total_boxes_qty; ?></b></div>
            <div class="col-lg-5">&nbsp;</div>
            <div class="col-lg-4" style="text-align: right"><?php echo $lang_amount; ?>: <b><?php echo number_format($total_after_vat,2)."&nbsp;".$lang_currency; ?></b></div>
        </div>   
        <div class="row" dir="<?php echo $dir; ?>">
       
            <div class="col-lg-3" style="text-align: left;"><?php echo $lang_total_items;?>:&nbsp;<b><?php echo $total_items_qty; ?></b></div>
            <div class="col-lg-5">&nbsp;</div>
        ...
        <div class="row" dir="<?php echo $dir; ?>">
            ...
            <div class="col-lg-3" style="text-align: left;"><?php echo $lang_total_global_boxes;?>:&nbsp;<b><?php echo $total_bixes_items_qty; ?></b></div>
            <div class="col-lg-5">&nbsp;</div>
            <div class="col-lg-4" style="text-align: right">
