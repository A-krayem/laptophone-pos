                            ...
                            <table id="invoices_list_table" class="table table-striped table-bordered" cellspacing="0">\n\
                                <thead>\n\
                                    <tr>\n\
                                        ...
                                        <th>Customer name</th>\n\
                                        <th style="width: 110px !important;">Original Value</th>\n\
                                        <th style="width: 110px !important;">Inv. Discount</th>\n\
                                        <th style="width: 110px !important;">Total Value</th>\n\
                                        <th style="width: 80px !important;">Payment</th>\n\
                            ...
                            <table id="return_items_table" class="table table-striped table-bordered" cellspacing="0" style="width:100%">\n\
                                <thead>\n\
                                    <tr>\n\
                                        ...
                                        <th style="width: 45px !important;">Disc.</th>\n\
                            ...
                            <table id="return_items_by_barcode_table" class="table table-striped table-bordered" cellspacing="0" style="width:100%">\n\
                                <thead>\n\
                                    <tr>\n\
                                        ...
                                        <th style="width: 42px !important;">Disc.</th>\n\
                                        <th style="width: 30px !important;">Vat</th>\n\
                                        <th>Inv. It. ID</th>\n\
                                        <th style="width: 50px !important;">&nbsp;</th>\n\
                                    </tr>\n\
...
function returnQty(id){
    if(enable_only_return_password==1){
        //closeModal("invoices_itemsModal");
        //closeModal("return_itemsModal");
        ...
        function(isConfirm) {
            if (isConfirm) {
                ...
                if($("#passdel").val() == only_return_password){
                    ...
                    var total_price = 0;
                    var returned_id = 0;
                    $.getJSON("?r=pos&f=returnBackItems&p0="+id+"&p1=1", function (data) {
