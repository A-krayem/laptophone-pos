function customers_cards(){
    ...
    $('#customer_cards_Modal').on('shown.bs.modal', function (e) {
        ...
        $('#garage_cards_table__').on('key-focus.dt', function(e, datatable, cell){
            $(garage_cards_table__var.row(cell.index().row).node()).addClass('selected');
        });

        $('#garage_cards_table__').on('key-blur.dt', function(e, datatable, cell){
            $(garage_cards_table__var.row(cell.index().row).node()).removeClass('selected');
        });
    });
