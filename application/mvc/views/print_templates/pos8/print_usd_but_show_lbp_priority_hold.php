...
echo "VENDOR NAME: " . $data["employee_info"][$data["employee_id"]]["username"];
echo "                </td>\r\n            </tr>\r\n\r\n            \r\n            \r\n             ";
...
for ($i = 0; $i < count($data["items"]); $i++) {
    ...
    $total_price += floatval($data["items"][$i]["final_price"] * $data["items"][$i]["qty"]);
    $unit_price = $data["items"][$i]["final_price"];
