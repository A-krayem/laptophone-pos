...
if (0 < strlen($this->settings_info["address"])) {
    echo "            <tr>\n                <td style=\"text-align: center;font-size: 24px;line-height: 22px;\">\n                    ";
...
echo "            \n            <tr>\n                <td style=\"height: 20px;\"></td>\n            </tr>\n            \n\n             \n            <tr>\n                <td style=\"text-align: center;font-size: 24px; text-align: center; font-weight: bold;line-height: 22px;\">\n                    SALES INVOICE                </td>\n            </tr>\n            \n            <tr>\n                <td style=\"text-align: center;font-size: 24px;text-align: center;line-height: 22px;\">\n                    ";
...
if (0 < strlen($data["customer_info"])) {
    echo "            <tr>\n                <td style=\"font-size: 24px; text-align: left;line-height: 22px; padding-left: 5px;\">\n                    \n                    <div class=\"line\"></div>\n                    ";
...
for ($i = 0; $i < count($data["items"]); $i++) {
    ...
    echo "                <td style=\"width: 230px;font-size: 18px;line-height: 22px;\" colspan=\"2\">\n                    ";
    echo $data["items"][$i]["item_id"] . " - " . $out;
    echo "                </td>\n            </tr>\n            \n            <tr>\n                <td style=\"width: 160px;font-size: 22px;line-height: 22px;\">";
    echo "" . self::value_format_custom_no_currency($unit_price, $this->settings_info) . " <b>X</b> " . (double) $data["items"][$i]["qty"];
    echo "</td>\n                <td style=\"font-size: 22px;\">";
    echo "<b>Total:</b><span style='float:right'>" . self::value_format_custom_no_currency($total, $this->settings_info) . "</span>";
    echo "</td>\n            </tr>\n            \n            ";
...
echo "        </table>\n        <div class=\"line\"></div>\n        \n        \n        \n        <table style=\"width: 100%; margin-top: 10px;\">\n            <tr>\n                <td  style=\"width: 160px;font-size: 22px;line-height: 22px;text-align: right\">\n                    <b>Items Quantity</b>\n                <td>\n                <td colspan=\"2\" style=\"width: 160px;font-size: 22px;line-height: 22px;text-align: right\">\n                    ";
echo $total_qty;
echo "                </td>\n            </tr>\n        </table>\n        \n        \n        <table style=\"width: 100%; margin-top: 10px;\">\n            <!-- <tr>\n                <td  style=\"width: 160px;font-size: 22px;line-height: 22px;text-align: right\">\n                    <b>Gross total</b>\n                <td>\n                <td colspan=\"2\" style=\"width: 160px;font-size: 22px;line-height: 22px;text-align: right\">\n                    ";
if ($data["currency_system_default"] == 1) {
    echo self::value_format_custom_no_currency($total_price * $data["invoice"][0]["rate"], $this->settings_info);
} else {
...
if ($data["currency_system_default"] == 1) {
    echo "            \n            <tr>\n                <td  style=\"width: 160px;font-size: 22px;line-height: 22px;text-align: right\">\n                    <b>Total in LBP:</b>\n                <td>\n                ";
    if (0 < $data["invoice"][0]["total_vat_value"]) {
        echo "                 <td colspan=\"2\" style=\"width: 160px;font-size: 22px;text-align: right\">\n                     ";
        echo self::value_format_custom_no_currency(($total_price + $discount_value) * $rate, $this->settings_info) . " ";
        echo $data["currencies"][1]["symbole"];
        echo "                     </b</td>\n                 ";
    } else {
        echo "                 <td colspan=\"2\" style=\"width: 160px;font-size: 22px;text-align: right\">";
        echo self::value_format_custom_no_currency(($total_price + $discount_value) * $rate, $this->settings_info) . " ";
...
echo "  \n            \n            ";
if ($data["currency_system_default"] == 1) {
    echo "            \n            <tr>\n                <td  style=\"width: 160px;font-size: 22px;line-height: 22px;text-align: right\">\n                    <b>Total in USD:</b>\n                <td>\n                    <td colspan=\"2\" style=\"width: 160px;font-size: 22px;text-align: right\">\n                ";
    echo self::value_format_custom_no_currency($total_price + $discount_value, $this->settings_info) . " ";
    echo $data["currencies"][1]["symbole"];
    echo "   \n                 <td>\n            </tr>\n            ";
}
echo "  \n            \n            \n            ";
if (0 < $data["invoice"][0]["rate"] && $data["currency_system_default"] == 1) {
    echo "            \n            <tr>\n                <td  style=\"width: 160px;font-size: 22px;line-height: 22px;text-align: right\">\n                    <b>Rate USD-LBP</b>\n                <td>\n                \n                <td colspan=\"2\" style=\"width: 160px;font-size: 22px;text-align: right\">";
