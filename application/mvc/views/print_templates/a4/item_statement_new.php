...
echo $_GET["p0"];
echo "&p1=\"+\$(\"#date_filter\").val());\r\n            }\r\n            \r\n            \r\n        </script>\r\n    </head>\r\n    <body class=\"A4\">\r\n        <section class=\"sheet padding-5mm\">\r\n            <input autocomplete=\"off\" id=\"date_filter\" class=\"tohide\" type=\"text\" placeholder=\"\" style=\"cursor:pointer;width:200px;margin-bottom: 5px;display: none\" value=\"\" />\r\n            <select id=\"currency\" onchange=\"refresh_statement()\" class=\"tohide\" style=\"width: 100px; height: 26px; display: none\">\r\n                <option ";
if ($_GET["p1"] == "1") {
    echo "selected";
}
echo " value=\"1\">";
...
echo " - <b>To Date:</b> ";
echo $data["end_date"];
echo "</td>\r\n                </tr>\r\n            </table> \r\n            \r\n            <table class=\"det_table\" style=\"width: 100%; margin-top: 5px;margin-bottom: 50px;\">\r\n                <tr style=\"background-color: #e5e3e3\">\r\n                    <td style=\"width: 130px; text-align: center\"><b>Date</b></td>\r\n                    <td style=\"text-align: center\"><b>Description</b></td>\r\n                    <td style=\"width: 130px;text-align: center\"><b>Quantity Variation</b></td>\r\n                    <td style=\"width: 90px;text-align: center\"><b>Stock</b></td>\r\n                </tr>\r\n                \r\n                \r\n                <tr>\r\n                    <td>";
echo $data["info"][0]["creation_date"];
echo " </td>\r\n                    <td>Item Added to the System</td>\r\n                    <td></td>\r\n                    <td style=\"text-align: center;\">0</td>\r\n                </tr>\r\n               \r\n                ";
$stock_var = 0;
for ($i = 0; $i < count($data["table"]); $i++) {
    echo "                <tr onclick=\"row_select(this)\">\r\n                        <td >";
    echo $data["table"][$i]["date"];
    echo "</td>\r\n\r\n                        <td>";
    echo $data["table"][$i]["description"];
    echo "</td>\r\n\r\n                        <td style=\"text-align: center;\">";
    if (0 < $data["table"][$i]["qty_in"]) {
        $stock_var += $data["table"][$i]["qty_in"];
        echo number_format($data["table"][$i]["qty_in"]);
    } else {
        if (0 < $data["table"][$i]["qty_out"]) {
            echo "-" . number_format($data["table"][$i]["qty_out"]);
            $stock_var -= $data["table"][$i]["qty_out"];
        } else {
            echo "";
        }
    }
    echo $data["table"][$i]["comment"];
    echo "</td>\r\n\r\n                     \r\n\r\n                        <td style=\"text-align: center;\">";
    echo number_format($stock_var);
    echo "</td>\r\n                    </tr>\r\n                    ";
}
echo "                    \r\n                    \r\n    \r\n            </table>\r\n\r\n        </section>\r\n    </body>\r\n</html>";
