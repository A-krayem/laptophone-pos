...
echo "</td>\r\n                </tr>\r\n            </table>\r\n            <div class=\"line\"></div>\r\n            \r\n            <table style=\"width: 100%; margin-top: 20px;\">\r\n                <tr>\r\n                    <td style=\"font-size: 20px;font-weight: bold;text-align: center\">Client Account Statement - ";
...
for ($i = 0; $i < count($data["st_of_acc"]); $i++) {
    ...
    echo "</td>\r\n\r\n                        <td>\r\n                            ";
    if (round($data["st_of_acc"][$i]["debit"], $data["settings"]["round_val"]) != 0) {
        echo self::value_format_custom_no_currency($data["st_of_acc"][$i]["debit"], $data["settings"]);
    }
    echo "                        </td>\r\n\r\n                        <td>\r\n                            ";
    if (round($data["st_of_acc"][$i]["credit"], $data["settings"]["round_val"]) != 0) {
...
echo "                    \r\n                    <tr onclick=\"row_select(this)\" style=\"background-color: #e0e0e0\">\r\n                        <td>&nbsp;</td>\r\n\r\n                        \r\n\r\n                        <td style=\"text-align: right;font-weight: bold\">TOTALS</td>\r\n\r\n                        <td style=\"font-weight: bold\">";
echo $data["total_debit"];
echo "</td>\r\n\r\n                        <td style=\"font-weight: bold\">";
