...
echo "</td>\r\n                </tr>\r\n            </table>\r\n            <div class=\"line\"></div>\r\n            \r\n            <table style=\"width: 100%; margin-top: 20px;\">\r\n                <tr>\r\n                    <td style=\"font-size: 20px;font-weight: bold;text-align: center\">IMEI Report</td>\r\n                </tr>\r\n                <!-- <tr>\r\n                    <td style=\"font-size: 17px;font-weight: bold;text-align: center\">Available Balance: ";
echo number_format($data["av_bal"], 2);
echo " </td>\r\n                </tr> -->\r\n                <tr>\r\n                    <td style=\"font-size: 14px;text-align: center\"><b>From Date:</b> ";
echo $data["start_date"];
echo " - <b>To Date:</b> ";
echo $data["end_date"];
echo "</td>\r\n                </tr>\r\n            </table> \r\n            <button id=\"exportButton\">Export to Excel</button>\r\n            <table class=\"det_table\" style=\"width: 100%; margin-top: 5px;margin-bottom: 50px;\" id=\"exportTable\">\r\n                <tr style=\"background-color: #e5e3e3\">\r\n                    <td style=\"width: 80px; text-align: center\"><b>Date</b></td>\r\n                    <td ><b>Description</b></td>\r\n                    <td style=\"text-align: center\"><b>Supplier</b></td>\r\n                    <td style=\"width: 75px;text-align: center\"><b>Customer</b></td>\r\n                    <td style=\"width: 75px;text-align: center; width: 70px\"><b>Invoice</b></td>\r\n                    <td style=\"width: 75px;text-align: center\"><b>IMEI 1</b></td>\r\n                    <td style=\"width: 90px;text-align: center\"><b>IMEI 2</b></td>\r\n                </tr>\r\n                ";
for ($i = 0; $i < count($data["imei_details"]); $i++) {
    echo "                    <tr onclick=\"row_select(this)\">\r\n                        <td>";
    $tmp = explode(" ", $data["imei_details"][$i]["creation_date"]);
    echo $tmp[0];
    echo "</td>\r\n                        <td>";
    echo $data["imei_details"][$i]["item_id"] . "-" . $data["imei_details"][$i]["description"];
    echo "</td>\r\n                        <td >";
    if (true) {
        echo $data["all_suppliers"][$data["imei_details"][$i]["supplier_id"]]["name"] . " / PID: " . $data["imei_details"][$i]["pi_id"];
    }
    echo "</td>\r\n                        <td >";
    if (0 < $data["imei_details"][$i]["customer_id"]) {
        echo $data["imei_details"][$i]["c_first_name"];
    }
    echo "</td>\r\n                        <td style=\"text-align: center;\">";
    echo $data["imei_details"][$i]["invoice_id"];
    echo "</td>\r\n                        <td >";
    echo $data["imei_details"][$i]["code1"];
    echo "</td>\r\n                        <td >";
    echo $data["imei_details"][$i]["code2"];
    echo "</td>                   \r\n                    </tr>\r\n                ";
}
echo "    \r\n            </table>\r\n        </section>\r\n    </body>\r\n</html>";
